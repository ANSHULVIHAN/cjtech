  ...
  return (
    <div className="footer">
        <div className="top-footer">
            <div to="mailto:jobiskille@gmail.com" className="email">support@cjtech.in</div>
            <div to="tel:7017990795" className="number">+917017990795</div>
        </div>
        ...
        <div className="copyright">Copyright &copy; {new Date().getFullYear()} <a className='anchor' href="/" style={{fontWeight:600}}><span style={{color:"skyblue"}}>&nbsp; Coding Jobs </span> <span style={{color:"skyblue"}}>Technologies &nbsp;</span></a> Pvt. Ltd. | All rights Reserved.</div>
    </div>
  )
}
